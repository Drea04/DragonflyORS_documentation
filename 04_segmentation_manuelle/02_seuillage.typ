...
*Facultatif :* Nous pouvons afficher l’histogramme des niveaux de gris en cochant la case *Show histogram*. Cela permet de sélectionner directement une plage spécifique de pixels dans l’histogramme (selected range).
